...
from DeepNEROnPOSTrain import MODEL_FOLDER, REPORT_FOLDER
from neuralnets.BiLSTM import BiLSTM
from util.preprocessing import readCoNLL, createMatrices, addCharInformation, addCasingInformation

PREDICTION_FOLDER = Util.get_project_folder() / "data/predictions/DeepNEROnPOS"
...
def test(data_path: Path, model_path: Path, prediction_path: Path):
    ...
    input_columns = {0: 'tokens', 1: 'POS', 2: 'chunk_BIO', 3: 'ner_BIO'}
    label_column = 'ner_BIO'
